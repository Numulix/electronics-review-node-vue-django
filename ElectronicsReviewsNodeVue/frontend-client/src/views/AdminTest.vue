            ...
            <div class="card-body">
              <b-form @submit="newProduct">
                ...
                <b-form-group
                  ...
                  label-for="prod-3"
                >
                  <b-form-textarea id="prod-3" v-model="product.prod_desc" placeholder="Product description"></b-form-textarea>
                </b-form-group>
                ...
                <b-form-group
                  ...
                  label-for="prod-4"
                >
                  <b-form-input id="prod-4" type="number" v-model="product.price"></b-form-input>
                </b-form-group>
